...
public extension EmptyDataSetDelegate {
  func emptyDataSetShouldFadeIn(_: UIScrollView) -> Bool {
    return true
  }

  func emptyDataSetShouldBeForcedToDisplay(_: UIScrollView) -> Bool {
    return false
  }
  ...
  func emptyDataSet(_: UIScrollView, didTapView _: UIView) {}

  func emptyDataSet(_: UIScrollView, didTapButton _: UIButton) {}

  func emptyDataSetWillAppear(_: UIScrollView) {}

  func emptyDataSetDidAppear(_: UIScrollView) {}

  func emptyDataSetWillDisappear(_: UIScrollView) {}

  func emptyDataSetDidDisappear(_: UIScrollView) {}
}
