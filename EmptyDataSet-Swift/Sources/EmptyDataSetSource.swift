...
public extension EmptyDataSetSource {
  ...
  func imageAnimation(forEmptyDataSet _: UIScrollView) -> CAAnimation? {
    return nil
  }
  ...
  func buttonImage(forEmptyDataSet _: UIScrollView, for _: UIControl.State) -> UIImage? {
    return nil
  }

  func buttonBackgroundImage(forEmptyDataSet _: UIScrollView, for _: UIControl.State) -> UIImage? {
    return nil
  }
